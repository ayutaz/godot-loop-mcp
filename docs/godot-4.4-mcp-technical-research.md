...
- 現行の milestone / quick reference: `docs/implementation-milestones.md`
...
この調査文書より現行挙動の source of truth を優先する場合は、`docs/implementation-milestones.md`, `docs/github-actions-cicd-plan.md` と実装コードを参照してください。
