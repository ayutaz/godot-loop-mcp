...
2026-03-13 時点では `M0` から `M6` の実装面が repo に反映済みで、`M5` は release hardening と publishing 設定を残して進行中です。
...
- 残作業: trusted publisher 設定、publishable package 化、`run_tests` report の Actions 統合
